# encoding: utf-8
# module _ssl
# from /System/Library/Frameworks/Python.framework/Versions/3.4/lib/python3.4/lib-dynload/_ssl.so
# by generator 1.135
"""
...
OPENSSL_VERSION = 'OpenSSL 0.9.8zd 8 Jan 2015'
...
err_names_to_codes = {
    ...
    'INVALID_STATUS_RESPONSE': '<value is a self-reference, replaced by this string>',
    'INVALID_TICKET_KEYS_LENGTH': (
        20,
        275,
    ),
    ...
    'NO_CLIENT_CERT_METHOD': '<value is a self-reference, replaced by this string>',
    'NO_CLIENT_CERT_RECEIVED': (
        20,
        186,
    ),
    ...
    'NO_RENEGOTIATION': '<value is a self-reference, replaced by this string>',
    'NO_REQUIRED_DIGEST': (
        20,
        324,
    ),
    ...
    'PSK_IDENTITY_NOT_FOUND': '<value is a self-reference, replaced by this string>',
    'PSK_NO_CLIENT_CB': (
        20,
        224,
    ),
    ...
    'SERVERHELLO_TLSEXT': '<value is a self-reference, replaced by this string>',
    'SESSION_ID_CONTEXT_UNINITIALIZED': (
        20,
        277,
    ),
    ...
    'SSL3_EXT_INVALID_SERVERNAME': '<value is a self-reference, replaced by this string>',
    'SSL3_EXT_INVALID_SERVERNAME_TYPE': (
        20,
        226,
    ),
